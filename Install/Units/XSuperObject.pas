...
begin
  ...
  case RType.Kind of
    ...
    tkEnumeration:
       ...
       begin
          Anc := IJsonData.Ancestor[Member];
          case Anc.DataType of
            dtInteger: SetValue<Typ>(Data, MemberValue, Member, (Anc as IJSONInteger).Value = 1);
            dtString:  if IsNumber((Anc as IJSONString).Value, CharIndex) then SetValue<Typ>(Data, MemberValue, Member, (Anc as IJSONString).Value.ToInteger = 1);
            else
